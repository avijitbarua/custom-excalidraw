      ...
      rollupOptions: {
        onwarn(warning, warn) {
          ...
          if (
            ...
            message.includes("Module level directives cause errors") ||
            message.includes("Error when using sourcemap for reporting") ||
            message.includes("didn't resolve at build time") ||
            message.includes("dynamic import will not move module")
          ) {
            return;
          }
