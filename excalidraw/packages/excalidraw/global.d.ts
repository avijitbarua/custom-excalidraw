...
// -----------------------------------------------------------------------------
// mathjax-full (no bundled types)
declare module "mathjax-full/js/mathjax" {
  export const mathjax: any;
}
declare module "mathjax-full/js/input/tex" {
  export class TeX {
    constructor(options?: any);
  }
}
declare module "mathjax-full/js/output/svg" {
  export class SVG {
    constructor(options?: any);
  }
}
declare module "mathjax-full/js/adaptors/liteAdaptor" {
  export const liteAdaptor: () => any;
}
declare module "mathjax-full/js/handlers/html" {
  export const RegisterHTMLHandler: (adaptor: any) => void;
}
