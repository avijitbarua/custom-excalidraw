...
import {
  actionOpenMathTypeDialog,
  actionSetQuizTemplate,
  actionToggleZenMode,
} from "../actions";
    ...
    <>
      ...
      <DropdownMenu open={isExtraToolsMenuOpen}>
        ...
        >
          ...
          {QUIZ_TEMPLATE_OPTIONS.map((option) => (
            <DropdownMenu.Item
              key={option.value}
              onSelect={() =>
                actionManager.executeAction(actionSetQuizTemplate, "ui", {
                  template: option.value,
                })
              }
              selected={getCurrentQuizTemplate() === option.value}
            >
              {option.label}
            </DropdownMenu.Item>
          ))}
          ...
          <DropdownMenu.Item
            onSelect={() =>
              actionManager.executeAction(actionOpenMathTypeDialog, "ui")
            }
            icon={TextSizeIcon}
            shortcut={getShortcutFromShortcutName("openMathTypeDialog")}
          >
            MathType (LaTeX)
          </DropdownMenu.Item>
        </DropdownMenu.Content>
